...
RowStatus, PhysAddress, TimeStamp, TruthValue, TextualConvention, AutonomousType, TestAndIncr, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "PhysAddress", "TimeStamp", "TruthValue", "TextualConvention", "AutonomousType", "TestAndIncr", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifHCInMulticastPkts=ifHCInMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifAdminStatus=ifAdminStatus, linkUp=linkUp, ifOutUcastPkts=ifOutUcastPkts, ifLastChange=ifLastChange, ifGeneralGroup=ifGeneralGroup, ifCompliance2=ifCompliance2, ifOutQLen=ifOutQLen, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifPhysAddress=ifPhysAddress, ifConnectorPresent=ifConnectorPresent, ifInUnknownProtos=ifInUnknownProtos, ifStackEntry=ifStackEntry, ifOperStatus=ifOperStatus, ifPacketGroup=ifPacketGroup, ifTestId=ifTestId, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressTable=ifRcvAddressTable, ifTable=ifTable, ifTestOwner=ifTestOwner, ifMIB=ifMIB, ifCompliance3=ifCompliance3, ifType=ifType, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifXTable=ifXTable, ifSpeed=ifSpeed, ifOutErrors=ifOutErrors, ifHCOutOctets=ifHCOutOctets, ifInMulticastPkts=ifInMulticastPkts, OwnerString=OwnerString, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliance=ifCompliance, interfaces=interfaces, ifRcvAddressAddress=ifRcvAddressAddress, ifAlias=ifAlias, ifGroups=ifGroups, ifGeneralInformationGroup=ifGeneralInformationGroup, ifEntry=ifEntry, ifOutOctets=ifOutOctets, ifCompliances=ifCompliances, ifStackGroup2=ifStackGroup2, ifTestStatus=ifTestStatus, ifStackTable=ifStackTable, ifHighSpeed=ifHighSpeed, ifMtu=ifMtu, ifMIBObjects=ifMIBObjects, ifInOctets=ifInOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifConformance=ifConformance, ifDescr=ifDescr, ifInErrors=ifInErrors, ifStackGroup=ifStackGroup, InterfaceIndex=InterfaceIndex, ifTestTable=ifTestTable, ifTestGroup=ifTestGroup, ifTestEntry=ifTestEntry, ifName=ifName, ifHCOutUcastPkts=ifHCOutUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifStackHigherLayer=ifStackHigherLayer, ifNumber=ifNumber, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifXEntry=ifXEntry, ifTestType=ifTestType, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressType=ifRcvAddressType, ifInUcastPkts=ifInUcastPkts, linkDown=linkDown, ifStackLastChange=ifStackLastChange, ifTestResult=ifTestResult, ifTableLastChange=ifTableLastChange, ifHCInOctets=ifHCInOctets, ifOutMulticastPkts=ifOutMulticastPkts, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressEntry=ifRcvAddressEntry, ifStackStatus=ifStackStatus, ifOutDiscards=ifOutDiscards, ifOldObjectsGroup=ifOldObjectsGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifInNUcastPkts=ifInNUcastPkts, ifInDiscards=ifInDiscards, ifHCPacketGroup=ifHCPacketGroup, ifSpecific=ifSpecific, ifHCInUcastPkts=ifHCInUcastPkts, ifTestCode=ifTestCode, ifStackLowerLayer=ifStackLowerLayer, ifIndex=ifIndex, ifHCOutMulticastPkts=ifHCOutMulticastPkts)
