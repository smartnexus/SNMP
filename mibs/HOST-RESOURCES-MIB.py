...
# Produced by pysmi-0.3.4 at Wed Apr 22 14:09:31 2020
...
mib_2, TimeTicks, Gauge32, iso, Bits, Unsigned32, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, ObjectIdentity, ModuleIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "TimeTicks", "Gauge32", "iso", "Bits", "Unsigned32", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Counter32")
TruthValue, TextualConvention, AutonomousType, DateAndTime, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "DateAndTime", "DisplayString")
...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSWRun=hrSWRun, hrSWInstalledName=hrSWInstalledName, hrSystemUptime=hrSystemUptime, hrNetworkIfIndex=hrNetworkIfIndex, hrStorageTypes=hrStorageTypes, hrMIBGroups=hrMIBGroups, hrMIBCompliance=hrMIBCompliance, hrDiskStorageTable=hrDiskStorageTable, hrPartitionIndex=hrPartitionIndex, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSystemProcesses=hrSystemProcesses, hrFSType=hrFSType, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSystemNumUsers=hrSystemNumUsers, hrSWOSIndex=hrSWOSIndex, hrSystemDate=hrSystemDate, hrFSTable=hrFSTable, hrPrinterStatus=hrPrinterStatus, hrSWRunIndex=hrSWRunIndex, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrProcessorLoad=hrProcessorLoad, hrFSIndex=hrFSIndex, hrSWRunName=hrSWRunName, hrSWRunParameters=hrSWRunParameters, hrDeviceEntry=hrDeviceEntry, hrSystemGroup=hrSystemGroup, hrSWRunType=hrSWRunType, hrStorageGroup=hrStorageGroup, hrFSStorageIndex=hrFSStorageIndex, hrFSBootable=hrFSBootable, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWInstalledDate=hrSWInstalledDate, hrMIBCompliances=hrMIBCompliances, hrPartitionSize=hrPartitionSize, hrSWRunID=hrSWRunID, hrSWRunPath=hrSWRunPath, hrSWRunGroup=hrSWRunGroup, hrDeviceErrors=hrDeviceErrors, hrSWInstalledTable=hrSWInstalledTable, hrStorageTable=hrStorageTable, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrPartitionFSIndex=hrPartitionFSIndex, hrSWInstalledGroup=hrSWInstalledGroup, hrStorageEntry=hrStorageEntry, hrSWRunPerf=hrSWRunPerf, hrStorageUsed=hrStorageUsed, hrPrinterEntry=hrPrinterEntry, hrDiskStorageAccess=hrDiskStorageAccess, hrSWRunStatus=hrSWRunStatus, hrDeviceIndex=hrDeviceIndex, ProductID=ProductID, hrSWRunPerfMem=hrSWRunPerfMem, hrSWRunPerfCPU=hrSWRunPerfCPU, hrNetworkEntry=hrNetworkEntry, KBytes=KBytes, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSWInstalledEntry=hrSWInstalledEntry, hrProcessorEntry=hrProcessorEntry, hrFSTypes=hrFSTypes, hrStorageDescr=hrStorageDescr, hrPrinterTable=hrPrinterTable, hrSWRunPerfGroup=hrSWRunPerfGroup, hrFSAccess=hrFSAccess, hrDeviceType=hrDeviceType, hrFSEntry=hrFSEntry, hrStorageSize=hrStorageSize, hrDiskStorageEntry=hrDiskStorageEntry, hrDeviceDescr=hrDeviceDescr, hrPartitionEntry=hrPartitionEntry, hrDeviceID=hrDeviceID, hrDeviceStatus=hrDeviceStatus, hrPartitionTable=hrPartitionTable, hrStorageType=hrStorageType, hrStorage=hrStorage, hrProcessorFrwID=hrProcessorFrwID, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSWRunEntry=hrSWRunEntry, host=host, hrStorageAllocationFailures=hrStorageAllocationFailures, hrFSMountPoint=hrFSMountPoint, hrStorageIndex=hrStorageIndex, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWInstalled=hrSWInstalled, hrSWRunPerfTable=hrSWRunPerfTable, hrProcessorTable=hrProcessorTable, hrPartitionID=hrPartitionID, hrSystem=hrSystem, hrSWInstalledType=hrSWInstalledType, InternationalDisplayString=InternationalDisplayString, PYSNMP_MODULE_ID=hostResourcesMibModule, hrDiskStorageMedia=hrDiskStorageMedia, hrSWRunTable=hrSWRunTable, hrDeviceTypes=hrDeviceTypes, hrMIBAdminInfo=hrMIBAdminInfo, hrSWInstalledID=hrSWInstalledID, hrNetworkTable=hrNetworkTable, hrSWInstalledIndex=hrSWInstalledIndex, hrDeviceTable=hrDeviceTable, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSystemMaxProcesses=hrSystemMaxProcesses, hrDeviceGroup=hrDeviceGroup, hrPartitionLabel=hrPartitionLabel, hostResourcesMibModule=hostResourcesMibModule, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSWRunPerfEntry=hrSWRunPerfEntry, hrDevice=hrDevice, hrMemorySize=hrMemorySize)
